...
- Các từ liên quan: gara ô tô, thang máy, công viên, bản đồ Google Maps, quét mã QR.
QUAN TRỌNG: Viết lại ĐÚNG y lời nói. TUYỆT ĐỐI KHÔNG tự thêm số căn/lô (vd "căn 23") nếu người nói không nói rõ con số đó. Nếu đoạn ghi âm im lặng hoặc không nghe rõ, trả về chuỗi RỖNG.
