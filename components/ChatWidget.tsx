...
export default function ChatWidget() {
  ...
  return (
    <>
      <button
        onClick={() => setOpen(o => !o)}
        className={`${positionClass} bottom-6 right-6 z-50 w-14 h-14 rounded-2xl bg-white text-gray-800 shadow-xl border border-gray-200 flex items-center justify-center text-2xl hover:-translate-y-1 hover:shadow-2xl transition-all duration-300 overflow-hidden`}
      ...
      {open && (
        <div className={`${positionClass} bottom-24 right-6 z-50 w-80 sm:w-96 h-[500px] flex flex-col rounded-2xl shadow-2xl bg-white border border-gray-200 overflow-hidden`}>
          {/* Header */}
